...
**О проекте:** Простой интернет-магазин с интуитивно понятным интерфейсом. Приложение включает в себя следующий функционал:

- 🛍️ Каталог товаров, предпросмотр товаров;
- 🛒 Работа с корзиной (добавление, удаление товаров);
- 📝 Оформления заказа в несколько шагов;

Проект выполнен в целях совершенствования навыков разработки архитектуры, работы с Typescript.
...
<details>
<summary><b>Базовый код</b></summary>
...
<details>
<summary><b>Компоненты модели данных</b></summary>

### 1. Класс `ICatalogItem` расширяет `Model`
...
### 2. Класс `BasketState` расширяет `Model`
...
### 3. Класс `AppState` расширяет `Model`
...
<details>
<summary><b>Компоненты представления</b></summary>
